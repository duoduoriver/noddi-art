...
export function getBaseUrl(): string {
  return publicEnv.VITE_BASE_URL;
}

/**
 * Auth client origin for browser requests.
 *
 * Canonical URLs still use VITE_BASE_URL, but auth XHR should follow the
 * current served origin so local preview ports (e.g. 8787) do not call 3000.
 */
