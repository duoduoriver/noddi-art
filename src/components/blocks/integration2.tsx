...
const BRAND_ICONS = [
  ...
  { Icon: IconBrandStripe, color: BRAND_COLORS.stripe },
  { Icon: IconBrandCloudflare, color: BRAND_COLORS.cloudflare },
  { Icon: IconBrandReact, color: BRAND_COLORS.react },
  { Icon: IconBrandTypescript, color: BRAND_COLORS.typescript },
